                ...
                <div className="row ">
                    <div className="col-lg-12  col-md-12 ">
                        ...
                        <div className="row box4">
                            <div className="col-lg-3 mx-md-auto mx-lg-0  col-md-4 col-sm-12 order-2 order-lg-1">
                            ...
                            <div className="col-lg-6 col-md-10 mx-auto  mx-md-auto mx-lg-0 col-sm-10 col-10 justify-content-center order-1 order-lg-2 ">
                                ...
                                <div className="row  ">
                                    ...
                                    <form className="mx-auto ">
                                        ...
                                        <NavLink className="nav-link text1 link1" to=''> Don't have an account yet?</NavLink>
