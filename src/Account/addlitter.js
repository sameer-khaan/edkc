                    ...
                    <div className="col-lg-10 col-md-10">
                        ...
                        <div className="row ">
                            <div className="col-lg-3 box5 box6 col-md-7 col-sm-10 col-10 d-flex flex-column ">                                   
                               ...
                               <NavLink to="./login">
                               <button style={{backgroundColor:bgcolor2,color:text2}} className=" mt-2 btn-login d-flex"><img src={img4} /> <p className="dogline"> Litters</p></button> 
                               </NavLink>
                               <NavLink  to="./login">
                               <button style={{backgroundColor:bgcolor3,color:text3}} className=" mt-2 btn-login "><p className="dogline1">  Dogs</p></button>  
                               </NavLink>
                            </div>
